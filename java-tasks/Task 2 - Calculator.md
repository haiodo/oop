...
2. Загружайте классы команд в фабрику с использованием аннотации. Фабрика должна конфигурироваться файлом в котором по строчо указываются jar файлы в которых находятся команды. Файл конфигурации должен храниться рядом с файлом класса-фабрики и загружаться с помощью Class.getResourceAsStream().
...
6. Предоставить возможность программного управления калькулятором.
